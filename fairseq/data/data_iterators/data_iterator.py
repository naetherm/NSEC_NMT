...
from fairseq.common.util import ensure_list, is_lazy, lazy_groups_of
from fairseq.data.dataset import Batch
from fairseq.data.fields.metadata_field import MetadataField
...
class DataIterator(Registrable):
  ...
  def index_with(self, vocab: Dictionary):
    self.vocab = vocab